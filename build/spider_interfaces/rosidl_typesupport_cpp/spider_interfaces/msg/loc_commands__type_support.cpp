...
static const _LocCommands_type_support_symbol_names_t _LocCommands_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spider_interfaces, msg, LocCommands)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, spider_interfaces, msg, LocCommands)),
  }
};
...
{
  return &::spider_interfaces::msg::rosidl_typesupport_cpp::LocCommands_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, spider_interfaces, msg, LocCommands)() {
  return get_message_type_support_handle<spider_interfaces::msg::LocCommands>();
}
