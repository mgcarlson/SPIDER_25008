...
bool spider_interfaces__msg__loc_commands__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("spider_interfaces.msg._loc_commands.LocCommands", full_classname_dest, 47) == 0);
  }
  spider_interfaces__msg__LocCommands * ros_message = _ros_message;
  {  // move_type
...
{
  /* NOTE(esteve): Call constructor of LocCommands */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("spider_interfaces.msg._loc_commands");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LocCommands");
