  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = spider_interfaces__msg__LocCommands;
    is_plain =
      (
      offsetof(DataType, move_amount) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _LocCommands__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_spider_interfaces__msg__LocCommands(
