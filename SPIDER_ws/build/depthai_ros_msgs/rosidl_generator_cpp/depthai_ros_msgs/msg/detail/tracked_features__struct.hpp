...
struct TrackedFeatures_
{
  ...
  using _features_type =
    std::vector<depthai_ros_msgs::msg::TrackedFeature_<ContainerAllocator>, typename ContainerAllocator::template rebind<depthai_ros_msgs::msg::TrackedFeature_<ContainerAllocator>>::other>;
  ...
  Type & set__features(
    const std::vector<depthai_ros_msgs::msg::TrackedFeature_<ContainerAllocator>, typename ContainerAllocator::template rebind<depthai_ros_msgs::msg::TrackedFeature_<ContainerAllocator>>::other> & _arg)
  {
    this->features = _arg;
    return *this;
  }
