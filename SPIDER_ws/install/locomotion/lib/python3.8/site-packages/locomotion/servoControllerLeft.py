...
class servoControllerLeft:
  ...
  def moveForwardBack(self):
    ...
    moveVertUp    = threading.Thread(target=self.moveServo, args=(self.driver, 4, VERT_UP_ANGLE))
    moveVertDown  = threading.Thread(target=self.moveServo, args=(self.driver, 4, VERT_DOWN_ANGLE))
